            ...
            <Row className='align-items-center p-4'>
                  ...
                  <Card style={{ width: '34rem',outline:"20px solid white", borderRadius:"0px" }} className='py-4'>
                    <Card.Body className='text-center'>
                              ...
                              <h1 className='fw-bold'  style={{color:"#90bc79"}}>$99</h1>
                        ...
                        <div className='d-flex justify-content-evenly align-items-center' >
                            <div className='p-2'>
                                <h1>0-226</h1>
                                <h4 className='text-secondary'>--Days--</h4>
                            </div>
                            <div className='p-2'>
                            <h1>21</h1>
                            <h4 className='text-secondary'>--Hours--</h4>
                            </div>
                            <div className='p-2'>
                            <h1>47</h1>
                            <h4 className='text-secondary'>--Mins--</h4>
                            </div>
                            <div className='p-2'>
                            <h1>40</h1>
                            <h4 className='text-secondary'>--Secs--</h4>
                            </div>
